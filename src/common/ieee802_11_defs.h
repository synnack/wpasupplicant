...
enum wnm_trans_status_code {
	WNM_TRANS_ACCEPT = 0,
	WNM_TRANS_REJECT_UNSPECIFIED = 1,
	WNM_TRANS_REJECT_INSUFFICIENT_BEACONS = 2,
	WNM_TRANS_REJECT_INSUFFICIENT_CAPACITY = 3,
	WNM_TRANS_REJECT_BSS_TERM_UNDESIRED = 4,
	WNM_TRANS_REJECT_BSS_DELAY_REQUEST = 5,
	WNM_TRANS_REJECT_STA_CANDIDATES_PROVIDED = 6,
	WNM_TRANS_REJECT_NO_SUITABLE_CANDIDATES = 7,
	WNM_TRANS_REJECT_LEAVING_ESS = 8,
};
